...
payload=[{
  ...
  "writers": [{ "name": "Writ Erson", "image": None }],
  "producers": [{ "name": "Pro Ducer", "image": None }],
  "cast": [
    { "name": "John Star", "character": "Hero", "image": None },
    { "name": "Mary CoStar", "character": "Partner", "image": None }
  ],
  "streaming": [
