                        ...
                        >
                            ...
                            >
                                ...
                                <motion.div
                                    ...
                                    initial={{ opacity: 0 }}
                                    animate={{ opacity: isMobile ? 1 : (isPosterHovered ? 1 : 0) }}
                                    transition={{ duration: 0.2 }}
                                >
                                    <Button
                                        size="sm"
                                        className={cn(
                                            "bg-[#00BFFF] hover:bg-[#00A3DD] text-black font-semibold",
                                            isMobile ? "w-full" : ""
                                        )}
                                    ...
                                    {/* Mobile-only: Always visible actions below poster (handled in main layout) */}
                                    {!isMobile && (
