...
interface EditCollectionModalProfileProps {
  collection: UserCollection
  onClose: () => void
  onSave: (collection: UserCollection) => void
}

export function EditCollectionModalProfile({
  collection,
  onClose,
  onSave,
}: EditCollectionModalProfileProps) {
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="p-4 bg-[#1A1A1A] border border-[#3A3A3A] rounded-lg">
              <div className="flex items-center justify-between text-sm font-dm-sans">
                <span className="text-[#A0A0A0]">Movies in collection:</span>
                <span className="text-[#E0E0E0] font-medium">{collection.movieCount}</span>
              </div>
              <div className="flex items-center justify-between text-sm font-dm-sans mt-2">
