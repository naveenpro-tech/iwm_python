  ...
  const stats = [
    {
      id: "followers",
      label: "Followers",
      value: (profile?.total_followers ?? profile?.follower_count ?? 0).toLocaleString(),
      color: "#00BFFF",
      position: { x: "15%", y: "25%" },
    },
    {
      id: "reviews",
      label: "Reviews",
      value: (profile?.total_reviews ?? profile?.review_count ?? 0).toLocaleString(),
      color: "#FFD700",
      position: { x: "40%", y: "15%" },
    },
    {
      id: "blog",
      label: "Blog Posts",
      value: (profile?.blog_count ?? 0).toLocaleString(),
      color: "#EC4899",
      position: { x: "65%", y: "15%" },
    },
    {
      ...
      value: (profile?.recommendation_count ?? 0).toLocaleString(),
      color: "#8B5CF6",
      position: { x: "85%", y: "25%" },
    },
    {
